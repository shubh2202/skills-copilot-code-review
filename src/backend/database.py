...
def init_database():
    ...
    if announcements_collection.count_documents({}) == 0:
        # Example announcement: expiration required, start_date optional
        now = datetime.now(timezone.utc)
        example = {
            "title": "Welcome Back!",
            "message": "Welcome to the new semester — activities are open for registration!",
            # start_date optional; None means immediately active
            "start_date": None,
            # expire in seven days from now by default
